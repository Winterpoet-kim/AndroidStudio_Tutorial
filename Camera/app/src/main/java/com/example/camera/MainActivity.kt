...
class MainActivity : AppCompatActivity() {
    ...
    // 문자열 형태의 사진 경로 값 (초기 값을 null로 시작하고 싶을 때)
    ...
    // startActivityForResult 를 통해서 받아온 사진 결과 값을 처리하기 위해서
    ...
    private fun savePhoto(bitmap: Bitmap) {
        ...
        if(!folder.isDirectory){ // 해당 경로에 폴더가 존재 하지 않느다면..
            folder.mkdir()
        }
